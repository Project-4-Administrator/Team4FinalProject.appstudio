...
const cacheName = 'calendarInteractiveDemo-2021-04-01 14:48:49.577801'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'calendarInteractiveDemo'.length) === 'calendarInteractiveDemo') {

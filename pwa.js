...
const cacheName = 'project_group_4-2021-03-31 17:34:21.310068'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'project_group_4'.length) === 'project_group_4') {
